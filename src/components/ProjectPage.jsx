...
• Developed a Regression based ensemble model using XgBoost and LgBoost combined with a VotingRegressor to achieve a RMSE of 12.43 on the test data.`,
  ...
  },
  {
    ...
    image: proj1,
    description: `Developed own portfolio website using ReactJs and Tailwind CSS. The website is responsive and has a clean design. The website is deployed on Netlify.`,
